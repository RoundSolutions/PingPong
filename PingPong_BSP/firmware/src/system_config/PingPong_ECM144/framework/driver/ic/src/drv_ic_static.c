...
{	
    PLIB_IC_ModeSelect(IC_ID_4, IC_INPUT_CAPTURE_EVERY_4TH_EDGE_MODE);
    ...
    PLIB_INT_VectorPrioritySet(INT_ID_0, INT_VECTOR_IC4, INT_PRIORITY_LEVEL2);
    PLIB_INT_VectorSubPrioritySet(INT_ID_0, INT_VECTOR_IC4, INT_SUBPRIORITY_LEVEL0);          

    /* Setup Error Interrupt */   
    PLIB_INT_SourceEnable(INT_ID_0, INT_SOURCE_INPUT_CAPTURE_4_ERROR);
    PLIB_INT_VectorPrioritySet(INT_ID_0, INT_VECTOR_IC4_ERROR, INT_PRIORITY_LEVEL1);
    PLIB_INT_VectorSubPrioritySet(INT_ID_0, INT_VECTOR_IC4_ERROR, INT_SUBPRIORITY_LEVEL0);      
}

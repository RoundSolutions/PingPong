 ...
 *******************************************/
    ...
    sd001 =
    {
        ...
        {'R','o','u','n','d',' ','S','o','l','u','t','i','o','n','s',' ','G','m','b','H'}
    };
...
void SYS_Initialize ( void* data )
{
    ...
    SYS_INT_VectorPrioritySet(INT_VECTOR_T5, INT_PRIORITY_LEVEL4);
    ...
    SYS_INT_VectorPrioritySet(INT_VECTOR_I2C2_MASTER, INT_PRIORITY_LEVEL4);
